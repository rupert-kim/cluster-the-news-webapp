...
/* .......................................................................... */
  ...
  */
  function getMovieInfo( n, nodeArray ) {
    info = '<div id="cover">';
    if( n.thumb )
      info += '<img class="cover"  src="' + n.thumb + '" title="' + n.label + '"/>';

    info +=
    '<div style="padding: 0 10px"> <div style="float: left"><a href="#" class="action" style="top: 280px;" title="" onclick="selectMovie('+n.index+',true);">relation with center node</a></div>'+
    '<div><a href="#" class="glyphicon glyphicon-remove" style="" onClick="toggleDiv(\'movieInfo\');">close</a></div></div>';
    ...
    if( n.director )
      info += '<div class=f><span class=l>Directed by</span>: <span class=d>'
           + n.director + '</span></div>';
    if( n.article )
      info += '<div class="f article"><span class=l>Article</span>: <span class=c>'
           + n.article + '</span></div>';
    if( n.duration )
